...
# A class method is a method that's bound to the class, not the instance.
# That means:
# It can access and modify class state (like class attributes).
# It takes cls as the first argument instead of self.
# You define it using the @classmethod decorator.
    @classmethod
    def square(cls, size=0):
        # creates and returns a new rectangle object where
        # both width and height are equal to size.
